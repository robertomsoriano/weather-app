...
import { colors, breakpoints } from "./colors";
...
class Degrees extends React.Component {
  ...
  render() {
    return (
      <SwitcherForm>
        <Item className={this.state.selectedValue === "C" ? "active" : ""}>
          <label>
            <input
              type="radio"
              name="radio"
        ...
        <Item className={this.state.selectedValue === "F" ? "active" : ""}>
          <label>
            <input
              type="radio"
              name="radio"
              ...
              tabIndex="0"
              onChange={
                this.state.selectedValue !== "F"
                  ? this.props.onDegreesChange
                  : null
              }
              onClick={this.state.selectedValue !== "F" ? this.setFar : null}
            />
            F
          </label>
        </Item>
